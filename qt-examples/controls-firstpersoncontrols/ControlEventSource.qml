...
Item {
    ...
    MouseArea {
        ...
        onPressed: {
            ...
            case 1:
            {
                if(timerRightDown.running)
                {
                    timerRightDown.stop();
                }
                if(!timerLeftDown.running)
                {
                    timerLeftDown.start();
                }
                break;
        ...
        onReleased: {
           timerRightDown.stop();timerLeftDown.stop();
        }
